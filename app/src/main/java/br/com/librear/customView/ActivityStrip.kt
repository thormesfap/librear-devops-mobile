...
class ActivityStrip @JvmOverloads constructor(context:Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    init{
        ...
        attrs?.let{
            context.withStyledAttributes(it, R.styleable.StripActivity, 0, 0){
                var imageResource = getResourceId(R.styleable.StripActivity_stripActivityImage, R.drawable.icon_camera)
                ...
                if(minutes == 0){
                    ...
                    activityImage.setImageDrawable(AppCompatResources.getDrawable(context, R.drawable.icon_book))
                }
